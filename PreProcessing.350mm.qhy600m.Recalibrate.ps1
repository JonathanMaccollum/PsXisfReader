...
$RecalibratedOutput = "E:\Recalibrated\350mm"
...
$FlatLibrary = Get-XisfFile -Path "$ArchiveDirectory\350mm\Flats" |
    Group-Object Instrument,Geometry,Filter,Telescope
$lightFrames=Get-Childitem -Path "$ArchiveDirectory\350mm" -Directory |
    foreach-object {
    ...
    where-object Object -eq "Leo Triplet Widefield"
$lightFrames.Length
