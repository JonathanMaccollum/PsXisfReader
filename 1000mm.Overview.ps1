...
$1000mmdata =
    (Get-ChildItem "E:\Astrophotography\1000mm\NGC1333 OSC" -Directory -Filter "*") +
    (Get-ChildItem "E:\Astrophotography\1000mm\NGC1333 Panel 2 OSC" -Directory -Filter "*") +
    (Get-ChildItem "E:\Astrophotography\1000mm\NGC1333 Panel 3 OSC" -Directory -Filter "*") |
