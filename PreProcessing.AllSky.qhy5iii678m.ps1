...
#>
#exit
[IO.Directory]::CreateDirectory("E:\Astrophotography\DarkLibrary\QHY5III678M")>>$null
$BiasLibraryFiles=Get-MasterBiasLibrary `
    -Path "E:\Astrophotography\BiasLibrary\QHY5III678M" `
...
$DarkLibraryFiles=Get-MasterDarkLibrary `
    -Path "E:\Astrophotography\DarkLibrary\QHY5III678M" `
...
while($true){
    $toCalibrate=Get-ChildItem $DropoffLocation/"2023-05-24" *.xisf -ErrorAction Continue |
        ...
        where-object Instrument -eq "QHY5III678M" |
