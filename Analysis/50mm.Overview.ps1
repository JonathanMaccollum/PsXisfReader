...
$50mmData =
    (Get-ChildItem "E:\Astrophotography\50mm" -Directory -Filter "*") |
...
$filters = $50mmData|Group-Object Filter|ForEach-Object{$_.Name}
$stats=$50mmData|
...
<#
$minDate=($50mmData|Measure-Object ObsDateMinus12hr -Minimum).Minimum
$maxDate=($50mmData|Measure-Object ObsDateMinus12hr -Maximum).Maximum
$byDate = $50mmData | Group-Object {[int]$_.ObsDateMinus12hr.ToString("yyyyMMdd")}
