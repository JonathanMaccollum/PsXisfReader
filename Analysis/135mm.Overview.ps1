...
$135mmData =
    (Get-ChildItem "E:\Astrophotography\135mm" -Directory -Filter "*Flaming*") |
...
<#
$minDate=($135mmData|Measure-Object ObsDateMinus12hr -Minimum).Minimum
$maxDate=($135mmData|Measure-Object ObsDateMinus12hr -Maximum).Maximum
$byDate = $135mmData | Group-Object {[int]$_.ObsDateMinus12hr.ToString("yyyyMMdd")}
